...
function UpdateCompaniesModel({visible, onClose,refreshCompaniesS:refreshMainCompanies,company }: Props) {
    ...
    const [imageLink, SetImageLink] = useState(company.image)
...
export default UpdateCompaniesModel