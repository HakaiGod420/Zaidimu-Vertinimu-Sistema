...
export default function CompanyCard({company:CompanyProp}:Props) {
    ...
    return (
        <div className='flex items-center space place-content-around'>
            ...
            <button
                className="p-8 border border-gray-200 rounded bg-white w-[500px] lg:w-[320px] md:w-[320px] hover:bg-gray-50 hover:border-b-4 hover:border-[#00df9a] active:bg-gray-100" >
